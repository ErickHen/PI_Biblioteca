import 'dart:convert';
import 'videoaula.dart';
import 'package:http/http.dart' as http;

class Servicos {
  static const URI =
      'http://192.168.100.2/ProjetoBiblioteca-main/dadosPHP/index.php';
  static const _GET_ALL = 'GET_ALL';
  static const _ADD_PESSOA = 'ADD_PESSOA';
  static const _DELETE_PESSOA = 'DELETE_PESSOA';
  static const _INSERE_REGISTRO = 'INSERE_REGISTRO';
  ...
  //add pessoa
  static Future<String> addPessoa(String nome) async {
    try {
      var map = Map<String, dynamic>();
  ...
  static Future<String> insereRegistro(String nome, livro, data) async {
    try {
      var map = Map<String, dynamic>();
      map['acao'] = _INSERE_REGISTRO;
      map['nome'] = nome;
      map['livro'] = livro;
      map['data'] = data;
      final resposta = await http.post(Uri.parse(URI), body: map);
      print('insereREGISTRO -> Resposta :: ${resposta.body}');
