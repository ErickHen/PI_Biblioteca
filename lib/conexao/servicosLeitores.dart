import 'dart:convert';
import 'dadosLeitores.dart';
import 'package:http/http.dart' as http;

class Servicos {
  static const URI =
      'http://192.168.100.2/ProjetoBiblioteca-main/dadosPHP/usuario.php';
  ...
  //add pessoa
  static Future<String> addPessoa(
      String nome, String telefone, String tipo, String datas) async {
    try {
      var map = Map<String, dynamic>();
