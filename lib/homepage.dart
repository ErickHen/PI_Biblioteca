...
import 'package:portfolio_website/views/autores_view.dart';
import 'package:portfolio_website/views/leitores_view.dart';
import 'package:portfolio_website/views/reservaEmprestimo_view.dart';
...
class _HomePageState extends State<HomePage>
  ...
  List<ContentView> contentViews = [
    ContentView(
      ...
      content: HomeView(), //Chamanado a View
    ),
    ContentView(
      tab: CustomTab(title: 'Autores'),
      content: AutoresView(), //Chamanado a View
    ),
    ContentView(
      tab: CustomTab(title: 'Leitores'),
      content: LeitoresView(), //Chamanado a view
    ),
    ContentView(
      tab: CustomTab(title: 'Livros'),
