...
class AutoresView extends StatefulWidget {
  const AutoresView({Key key}) : super(key: key);

  @override
  _AutoresViewState createState() => _AutoresViewState();
}
...
class _AutoresViewState extends State<AutoresView> {
  ...
  List<Project> projects = [
    Project(
        ...
        imageURL: 'machadoassis.jpg',
        description: 'Cadastrar os autores disponíveis na biblioteca.'),
    Project(
        title: 'Autores Cadastrados',
        imageURL: 'escritor1.jpg',
        description: ' Registrar todos os autores já cadastrados.'),
  ];
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        RaisedButton(
                          onPressed: () {
                            Navigator.of(context).pushNamed('/autores');
                          },
                        ...
                        RaisedButton(
                          onPressed: () {
                            Navigator.of(context).pushNamed('/consultaAutores');
                          },
